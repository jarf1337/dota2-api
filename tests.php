...
$matches_mapper_web->set_account_id(127454372);

// LOAD ALL MATCHES FOR A PLAYER AND SAVE THEM TO THE DB
do 
{
	$matches_short_info = $matches_mapper_web->load($lastMatchID);
	...
	$lastMatchID = $match_mapper->get_match_id();
}	while($matches_mapper_web->get_total_matches() >= 25);
/*
